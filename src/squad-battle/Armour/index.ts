...
import { ArmourConfig, ArmourState } from "shared/class/battle/Systems/CombatSystem/Armour/types";
import Logger from "shared/utils/Logger";
import { iArmour } from "./type";

export default class Armour implements iArmour {
